        ...
        <nav aria-label="main menu" class="menu">
            <div class="menu__aux">
                ...
                <ul class="menu__firstLevel"
                    ...
                    <li v-for="(menuItem, index) in menuList" role="none" class="menu__firstLevelVoice" :class = "{'menu__firstLevelVoice--open' : isOpen == index}">
                        ...
                        :aria-label="menuItem.text">
                            <li role="none" class="menu__secondLevelVoice" v-for="(subitem, index) in menuItem.submenu">
                                <a role="menuitem" 
                                :href="subitem.link"
